...
\date{\today}
\institute{Master 1 Génie Logiciel \\ \todo{Université}}
...
\begin{center}
\placeholder{0.8\textwidth}{Architecture Pepper Battleship (Backend Python + Frontend Web)}
\end{center}
...
\begin{center}
\placeholder{0.9\textwidth}{Schéma : Intégration Flask - Backend Python - SQLite}
\end{center}
\end{frame}
...
\column{0.5\textwidth}
\begin{center}
\placeholder{0.45\textwidth}{Capture d'écran Landing Page}
\end{center}
\end{columns}
\end{frame}
...
\vspace{0.5cm}
\begin{center}
\placeholder{0.7\textwidth}{Schéma : État transitions de la machine à états}
\end{center}
\end{frame}
...
\vspace{1cm}
\begin{center}
\placeholder{0.8\textwidth}{Capture d'écran : Deux grilles côte à côte}
\end{center}
\end{frame}
...
\vspace{0.5cm}
\begin{center}
\placeholder{0.7\textwidth}{Capture d'écran : Widget d'évaluation}
\end{center}
\end{frame}
...
\vspace{0.5cm}
\begin{center}
\placeholder{0.75\textwidth}{Schéma : Flux d'appels API pour une partie}
\end{center}
\end{frame}
...
\begin{center}
\placeholder{0.85\textwidth}{Diagramme UML : Hiérarchie Player}
\end{center}
...
\vspace{0.5cm}
\begin{center}
\placeholder{0.75\textwidth}{Schéma : Relations entre classes}
\end{center}
\end{frame}
...
\vspace{0.5cm}
\begin{center}
\placeholder{0.75\textwidth}{Schéma : Diagramme E-R}
\end{center}
\end{frame}
...
\vspace{0.5cm}
\begin{center}
\placeholder{0.8\textwidth}{Schéma : Flux complet client-serveur}
\end{center}
\end{frame}
...
Label 1 = \todo{Humain ou CheatBot}

Label 2 = \todo{CheatBot ou Humain}
...
\vspace{0.5cm}
\begin{center}
\placeholder{0.75\textwidth}{Graphique attendu : Scores de confiance par condition}
\end{center}
\end{frame}
