...
\begin{itemize}
    ...
    \item Quota prédéfini par tour : [1, 2, 0, 3, 3, 2, 1, 4, 2, 1, 3]
\end{itemize}
...
\begin{enumerate}
    ...
    \item Résultats → enregistrement PostgreSQL
    \item Scores de confiance → base de données
\end{enumerate}

\vspace{0.5cm}
\begin{center}
\includegraphics[width=0.85\textwidth]{../rapport/diagrams/images/synchro.png}
\end{center}
\end{frame}
...
\begin{enumerate}
    ...
    \item Combat
    \item Évaluation de confiance après chaque tour du bot
...
\end{itemize}
\vspace{0.5cm}
\textbf{Implications pour le design éthique d'IA}
\end{frame}
